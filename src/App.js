...
function App() {
      ...
      try {
        ...
        if (eeid) {
          ...
          const [componentsResponse, questionsResponse] = await Promise.all([
            axios.get(`https://app-survey.vercel.app/components?eeid=${eeid}`),
            axios.get(`https://app-survey.vercel.app/questions`),
          ]);
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      await axios.post("https://app-survey.vercel.app/components", surveyData);
